...
def auto():
  ...
  DRC.turn_for(vex.TurnType.LEFT, 120, vex.RotationUnits.DEG)
  DRC.drive_for(vex.DirectionType.REV, 9, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 15, vex.RotationUnits.REV)
