...
def auto():
  ...
  flywheelstart()
  DRC.drive_for(vex.DirectionType.REV, 48, vex.DistanceUnits.IN)
  intake.rotate_for_time(vex.DirectionType.FWD, 0.6, vex.TimeUnits.SEC)
  DRC.drive_for(vex.DirectionType.FWD, 48, vex.DistanceUnits.IN)
  DRC.drive_for(vex.DirectionType.REV, 1, vex.DistanceUnits.IN)
  DRC.turn_for(vex.TurnType.LEFT, 115, vex.RotationUnits.DEG)
  DRC.drive_for(vex.DirectionType.REV, 20, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 10, vex.RotationUnits.REV)
  DRC.drive_for(vex.DirectionType.REV, 6, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 5, vex.RotationUnits.REV)
  flywheelstop()
  DRC.drive_for(vex.DirectionType.REV, 15, vex.DistanceUnits.IN)
