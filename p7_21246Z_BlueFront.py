...
def auto():
  ...
  intake.rotate_for(vex.DirectionType.FWD, 1.2, vex.RotationUnits.REV)
  DRC.drive_for(vex.DirectionType.REV, 10, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 1, vex.RotationUnits.REV)
  flywheelstop()
  DRC.drive_for(vex.DirectionType.REV, 15, vex.DistanceUnits.IN)
