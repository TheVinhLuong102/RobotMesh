...
def auto():
  ...
  DRC.drive_for(vex.DirectionType.FWD, 47, vex.DistanceUnits.IN)
  DRC.drive_for(vex.DirectionType.REV, 0.5, vex.DistanceUnits.IN)
  DRC.turn_for(vex.TurnType.LEFT, 90, vex.RotationUnits.DEG)
