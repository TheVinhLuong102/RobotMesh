...
def auto():
  ...
  DRC.drive_for(vex.DirectionType.FWD, 9, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 15, vex.RotationUnits.REV)
  DRC.drive_for(vex.DirectionType.FWD, 6, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 5, vex.RotationUnits.REV)
  flywheelstop()
  DRC.drive_for(vex.DirectionType.FWD, 15, vex.DistanceUnits.IN)
