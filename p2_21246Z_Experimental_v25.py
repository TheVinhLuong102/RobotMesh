...
def auto():
  ...
  DRC.turn_for(vex.TurnType.LEFT, 114, vex.RotationUnits.DEG)
  ...
  intake.rotate_for(vex.DirectionType.FWD, 0.5, vex.RotationUnits.REV)
  flywheelstop()
  DRC.drive_for(vex.DirectionType.REV, 15, vex.DistanceUnits.IN)
