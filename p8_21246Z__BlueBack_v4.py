...
def auto():
  ...
  DRC.start_drive_for(vex.DirectionType.REV, 48, vex.DistanceUnits.IN)
  DRC.start_drive_for(vex.DirectionType.REV, 47, vex.DistanceUnits.IN)
