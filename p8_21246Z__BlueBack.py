...
def auto():
  ...
  DRC.drive_for(vex.DirectionType.REV, 42, vex.DistanceUnits.IN)
  DRC.set_timeout(1, vex.TimeUnits.SEC)
  DRC.drive_for(vex.DirectionType.FWD, 3.5, vex.DistanceUnits.IN)
  sys.sleep(0.5)
