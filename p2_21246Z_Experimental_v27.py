...
def auto():
  ...
  DRC.drive_for(vex.DirectionType.REV, 13, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 1, vex.RotationUnits.REV)
  DRC.drive_for(vex.DirectionType.REV, 12, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 1, vex.RotationUnits.REV)
  flywheelstop()
