...
def auto():
  ...
  DRC.turn_for(vex.TurnType.LEFT, 110, vex.RotationUnits.DEG)
  DRC.drive_for(vex.DirectionType.REV, 25, vex.DistanceUnits.IN)
  intake.rotate_for(vex.DirectionType.FWD, 3, vex.RotationUnits.REV)
